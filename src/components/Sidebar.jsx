...
import { 
  LayoutDashboard, Package, Heart, Users, BarChart, Settings, LogOut 
} from "lucide-react";
...
const Sidebar = () => {
  ...
  Manu WebApp
      ...
      <ul className="space-y-2 p-5">
        ...
        <li>
          <Link to="marketplace" className="flex items-center space-x-3 p-2 rounded-md hover:bg-blue-100 hover:border-l-4 hover:border-blue-600">
        ...
        <li>
          <Link to="users" className="flex items-center space-x-3 p-2 rounded-md hover:bg-blue-100 hover:border-l-4 hover:border-blue-600">
            <Users size={20} className="text-gray-600" />
            <span>Users</span>
          </Link>
        </li>
        <li>
          <Link to="reports" className="flex items-center space-x-3 p-2 rounded-md hover:bg-blue-100 hover:border-l-4 hover:border-blue-600">
