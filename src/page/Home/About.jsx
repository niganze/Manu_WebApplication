      ...
      <div className="container mx-auto px-6">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="text-center mb-12">
            <h2 className="text-4xl font-bold text-green-700 mb-4">Manu</h2>
            <p className="text-xl text-gray-700 font-medium">Leading Innovator in the Built Environment Sector</p>
          </div>
          
          {/* Main content with styling */}
          <div className="bg-white rounded-lg shadow-lg p-8 mb-12">
            <p className="text-gray-700 mb-6">
              Manu is a leading innovator in the built environment sector, developing cutting-edge tools and services designed to support stakeholders in the built environment sector, enabling them to address their specific needs and accelerate the adoption of reuse practices and embed Circular Economy practices within the built environment.
            </p>
            
            <p className="text-gray-700 mb-6">
              With a mission to accelerate the transition toward circularity, Manu supports developers, architects, policymakers, and industry professionals in integrating environmentally responsible solutions into their projects to minimize reliance on virgin materials, reduce greenhouse gas emissions, and lower embodied ecological impacts and waste generation, to name a few.
            </p>
            
            <p className="text-gray-700 mb-6">
              We collaborate with forward-thinking partners, leveraging innovation and data-driven insights to reshape the future of construction and urban development. Our mission is to transform the way materials are sourced, used, and repurposed, ensuring that the built environment contributes positively to both people and the planet.
            </p>
            
            <p className="text-gray-700 mb-6">
              By bridging the gap between traditional practices and regenerative design, we enable stakeholders to meet sustainability goals while fostering economic resilience. At Manu, we believe that the built environment should not only serve present needs but also contribute to a healthier, more circular, and equitable future.
            </p>
            
            <p className="text-gray-700">
              As the industry evolves, we continue to adapt, refine, and expand our solutions to support a more sustainable, low-carbon, and waste-free world.
            </p>
          </div>
          
          {/* Call to action */}
          <div className="text-center">
            <h3 className="text-2xl font-semibold mb-6 text-gray-800">Ready to Transform the Built Environment?</h3>
            <div className="flex justify-center gap-4">
              <a href="#contact" className="bg-green-600 hover:bg-green-700 text-white px-6 py-3 rounded-lg font-medium transition-colors duration-300">
                Contact Us
              </a>
              <a href="#services" className="bg-blue-600 hover:bg-blue-700 text-white px-6 py-3 rounded-lg font-medium transition-colors duration-300">
                Our Services
              </a>
            </div>
          </div>
...
<div className="bg-white py-16">
        <div className="container mx-auto px-6">
          <h2 className="text-3xl font-bold text-center text-gray-800 mb-12">Our Main Activities</h2>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-6xl mx-auto">
            <div className="bg-green-50 rounded-lg p-6 shadow-md">
              ...
              <h3 className="text-xl font-semibold mb-3 text-gray-800">Digital Tools Administration</h3>
              <p className="text-gray-600">Connecting available building materials on the secondary market with those looking for secondary building products and diverting surplus to community projects.</p>
            </div>
            ...
            <div className="bg-green-50 rounded-lg p-6 shadow-md">
              ...
              <h3 className="text-xl font-semibold mb-3 text-gray-800">Training & Capacity Building</h3>
              <p className="text-gray-600">Providing education in the reuse of materials and circular economy principles for the construction industry.</p>
            </div>
            ...
            <div className="bg-green-50 rounded-lg p-6 shadow-md">
              ...
              <h3 className="text-xl font-semibold mb-3 text-gray-800">Material Recovery & Deconstruction</h3>
              <p className="text-gray-600">Specialized services for recovering materials from buildings and careful deconstruction to preserve reusable components.</p>
            </div>
            ...
            <div className="bg-green-50 rounded-lg p-6 shadow-md">
              ...
              <h3 className="text-xl font-semibold mb-3 text-gray-800">Material Reconditioning</h3>
              <p className="text-gray-600">Restoring and reconditioning salvaged materials through specialized workshops and channels to prepare them for reuse.</p>
            </div>
            ...
            <div className="bg-green-50 rounded-lg p-6 shadow-md">
              ...
              <h3 className="text-xl font-semibold mb-3 text-gray-800">Consulting & Studies</h3>
              <p className="text-gray-600">Expert consulting on material reuse, sales and supply assistance for all construction industry stakeholders.</p>
            </div>
            ...
            <div className="bg-green-50 rounded-lg p-6 shadow-md">
              ...
              <h3 className="text-xl font-semibold mb-3 text-gray-800">Environmental Impact Assessments</h3>
              <p className="text-gray-600">Conducting EIAs and Circularity Audits to measure and improve the environmental performance of projects.</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="bg-gray-50 py-16">
        <div className="container mx-auto px-6">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-3xl font-bold text-center text-gray-800 mb-8">Why We Need to Save Building Materials</h2>
            
            <div className="bg-white rounded-lg shadow-lg p-8">
              <div className="mb-6">
                <h3 className="text-xl font-semibold mb-4 text-green-700">The Construction Sector's Impact</h3>
              ...
              <div className="mb-6">
                <h3 className="text-xl font-semibold mb-4 text-green-700">The Waste Problem</h3>
                <p className="text-gray-700 mb-4">
              ...
              <div>
                <h3 className="text-xl font-semibold mb-4 text-green-700">Rwanda's Growing Challenge</h3>
                <p className="text-gray-700">
      ...
      <div className="bg-white py-16">
        <div className="container mx-auto px-6">
          <h2 className="text-3xl font-bold text-center text-gray-800 mb-12">The Team</h2>
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6 max-w-5xl mx-auto">
            ...
            <div className="text-center">
              ...
              <h4 className="font-medium text-gray-800">Jane Doe</h4>
              <p className="text-sm text-gray-600">Circular Economy Specialist</p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-sm text-gray-600">Materials Engineer</p>
            </div>
            ...
            <div className="text-center">
              ...
              <h4 className="font-medium text-gray-800">Maria Garcia</h4>
              <p className="text-sm text-gray-600">Sustainable Architect</p>
            </div>
            ...
            <div className="text-center">
              ...
              <h4 className="font-medium text-gray-800">David Kimani</h4>
              <p className="text-sm text-gray-600">Deconstruction Expert</p>
            </div>
          </div>
        </div>
      </div>
        ...
        <div className="container mx-auto px-6">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="bg-white rounded-lg shadow-lg p-8">
              ...
              <div className="text-center">
                <a href="#contact" className="inline-block bg-green-600 hover:bg-green-700 text-white font-medium px-8 py-4 rounded-lg transition-colors duration-300 text-lg">
                  Join Our Movement
                </a>
              </div>
            </div>
